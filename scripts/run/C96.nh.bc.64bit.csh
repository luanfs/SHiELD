#!/bin/tcsh
# Gaea 
#SBATCH --output=/ncrc/home2/Luan.Santos/SHiELD/scripts/run/stdout/%x.o%j
...
set BUILD_AREA = "/ncrc/home2/Luan.Santos/SHiELD/SHiELD_build" 
set SCRATCHROOT = "/gpfs/f5/gfdl_w/scratch/Luan.Santos"
set SCRIPT_AREA = /ncrc/home2/Luan.Santos/SHiELD/SHiELD_build
...
set OUTDIR="${GRID}.${MEMO}.g$gtype.hord$hord.T$Tf.$MODE"
...
"dynamics", "ps_av", "ps_av",   "atmos_daily", "all", .false.,  "none", 2,
...
"dynamics", "te", "te",   "atmos_daily", "all", .false.,  "none", 2,
